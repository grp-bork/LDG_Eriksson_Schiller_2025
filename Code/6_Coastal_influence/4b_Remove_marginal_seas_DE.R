## ====================================================================================================
## This R script removes marginal seas from prokaryotic richness model outputs to focus the
## analysis on open ocean regions. It uses IHO (International Hydrographic Organization) ocean
## region classifications to filter out enclosed and semi-enclosed seas that may have different
## oceanographic characteristics than open ocean environments.
##
...
##
## Input files:  
##   - CSV with model uncertainty metrics across coastal distance groups
##   - IHO ocean regions function for spatial classification
##
## Output files: 
##   - Filtered CSV with marginal seas removed
##   - Dataset focused on open ocean regions for comparative analysis
##
## Strategy:
...
##   associated basins and gulfs. This filtering ensures that coastal influence analyses
##   focus on truly oceanic environments and avoid potential confounding effects from
##   enclosed sea dynamics.
##
...
# Directories
wd_in <- "Code/6_Coastal_influence/4_Output/Model_uncertainty_across_distance_groups_annualRichness_prokaryotes.csv"
wd_out <- "Code/6_Coastal_influence/4b_Output/"
...
fwrite(df_filtered, file.path(wd_out, "Model_uncertainty_across_distance_groups_no_marginal_seas_prokaryotes.csv"))
