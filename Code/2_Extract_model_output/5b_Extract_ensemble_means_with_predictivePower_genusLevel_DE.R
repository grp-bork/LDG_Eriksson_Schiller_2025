## ====================================================================================================
## This R script extracts ensemble means and uncertainties from CEPHALOPOD species distribution 
## model outputs for genus-level prokaryotic taxa. It processes model projections to compute monthly
## and annual ensemble means and standard deviations, calculates latitudinal diversity gradients 
## (LDG) with uncertainty quantification, and merges results across taxonomic classes.
##
...
##
## Input files:  
##   - CEPHALOPOD model outputs in: Code/Cephalopod_output/Non_log_genusLevel/
##   - Model parameter files: CALL.RData, QUERY.RData, MODEL.RData
##
## Output files: 
##   - Ensemble mean and standard deviation rasters (.RData files)
##   - LDG uncertainty statistics (monthly and annual CSV files)
##   - Merged uncertainty datasets across taxonomic classes
##
## Strategy:
##   This script performs a three-stage analysis: (1) extracts ensemble means and standard deviations
##   from genus-level CEPHALOPOD SDM outputs using parallel processing, computing monthly and annual
##   statistics across algorithms and bootstrap replicates with quality control filtering; 
##   (2) quantifies LDG uncertainties by computing latitudinal diversity statistics (min, max, mean,
##   median, SD, IQR) across ensemble members for both monthly and annual timescales; and 
##   (3) merges uncertainty results across class-level taxonomic clades to create consolidated
##   datasets for downstream analysis and visualization.
##
...
setwd("/home/deriksson/Projects/CEPHALOPOD")
source(file = "/home/deriksson/Projects/CEPHALOPOD/code/00_config.R")
...
## ====================================================================================================
## SECTION 1: Extract Ensemble Means and Standard Deviations (Genus Level)
## ====================================================================================================
...
## ====================================================================================================
## SECTION 2: Latitudinal Diversity Gradient (LDG) Uncertainty Quantification
## ====================================================================================================
...
# Define depth levels: Mixed Layer Depth (MLD) or 0-10 meters  
...
## ====================================================================================================
## SECTION 3: Merge Results Across Taxonomic Classes
## ====================================================================================================
...
## ====================================================================================================
## SECTION 4: Additional Analysis (Percentage Increase - Optional)
## ====================================================================================================

### Note: This section is currently not needed but preserved for future use
